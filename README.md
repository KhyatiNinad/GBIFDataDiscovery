...
A **Robust Data Enrichment Process** for GBIF mediated data using **Software based Analytics Framework**. 
...
4. Open the Data Load Editor 
5. In the 'Main' Script Section, you can change the variables for Start Year, End Year, Location Grid granularity in degrees and Half Ignorance Factor.
6. Now click on ‘Load Data’. The App will automatically generate all the Dashboards.
7. Open the ‘App Overview’ and View the Trends, using flexible filters and visualize the available data through interactive charts and maps
8. Obtain insights on Data Gap Analysis, either through the in-built KPIs or through self discovery
